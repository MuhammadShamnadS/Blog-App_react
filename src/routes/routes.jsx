...
import AdminUserList from "../pages/Dashboards/Admin/AdminUserLists";
import GuestSearchPosts from "../pages/Dashboards/Guest/GuestSearchPosts";
...
const CreatePostByAuthor = lazy(() => import("../pages/Dashboards/Authors/CreatePostByAuthor"));
        ...
        children: [
...

          {
            ...
            children: [
              ...
              { path: "users", element: <Loadable><AdminUserList /></Loadable> },
...

          {
            ...
            children: [
              ...
              { path: "post/search", element: <Loadable><GuestSearchPosts /></Loadable> },
...

          {
            ...
            children: [
              ...
              { path: "form", element: <Loadable><CreatePostByAuthor /></Loadable> },
            ],
          },
